      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select name="org_id" required class="form-control" readonly>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select name="branch_id" required class="form-control" readonly>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select name="dept_id[]" required class="form-control multipleSelect" multiple readonly>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="date" class="form-control" name="dob" id="dob" placeholder="Enter Email" required value="<?php echo $row->dob ?>" readonly>
          </div>
        </div>
      </div>
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="adhaar_number" name="adhaar_number" placeholder="Enter Adhaar Number" required value="<?php echo $row->adhaar_number ?>" readonly>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="alternate_mobile" name="alternate_mobile" placeholder="Enter Alternate Contact Number" required value="<?php echo $row->alternate_mobile ?>" readonly>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            <label for="email">Email :</label>
            <input type="email" class="form-control" name="email" id="email" placeholder="Enter Email" required readonly value="<?php echo $row->email ?>" readonly>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="salary_structure" id="salary_structure" placeholder="Enter Salary Structure" class="form-control" required value="<?php echo $row->salary_structure ?>" readonly>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select name="proof_type" required class="form-control" readonly>
      ...
      <div class="row"> 
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <select name="emp_status" required class="form-control" readonly>
