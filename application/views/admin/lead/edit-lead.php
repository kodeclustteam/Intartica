...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item active">Edit New Lead</li>
</ol>
<!-- Page Content -->
<h4>Edit New Lead
...
<div class="row">
  ...
  <!-- Tab panes -->
<form action="<?php echo base_url('admin/leads/edit_submit/'.$row->id) ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Enter Customer Name" required value="<?php echo $row->full_name ?>">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            <label for="address">Address :</label>
            <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" required value="<?php echo $row->address ?>">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="city" name="city" placeholder="Enter City" required value="<?php echo $row->city ?>">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="mobile" id="mobile" placeholder="Enter Phone Number" required value="<?php echo $row->mobile ?>">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            <input type="text" name="addl_desc" id="addl_desc" class="form-control" required placeholder="Enter More Details" value="<?php echo $row->addl_desc ?>">
          </div>
        </div>
      </div>
      <div class="row">
...
<!-- ends here -->
<?php if($this->router->fetch_class()=='leads' && $this->router->fetch_method()=='edit'): ?>
